...
public class Main {
    ...
    private void run() {
        ...
        ArrayList<Abiturient> abiturients = createList();
        int o;
        while ((o = menu()) != 0){
            switch (o){
    ...
    public static ArrayList<Abiturient> createList(){
        ArrayList<Abiturient> abiturients = new ArrayList<>();
        abiturients.add( new Abiturient(1, "Брик", "Йосип", "Яромирович", "680 AMSTERDAM AVE",14567842, 11.5));
        abiturients.add(new Abiturient(2,"Зноба","Йосип","Денисович","560 BLAKE AVE",97634521, 8.4));
        abiturients.add( new Abiturient(3,"Гужва","Іоанн","Захарович","101 CLAY ST",24397164, 6.7));
        abiturients.add( new Abiturient(4,"Білинський","Царук","Радимович","17 LAKE RD",73649820, 4.9));
        abiturients.add(new Abiturient(5,"Кабаненко","Есфір","Пилипович","122 HILLSIDE AVE",55314608, 12.0));
        return abiturients;
